...
echo -e '\033[31;40;1m 
 ...
 ╚═╝  ╚═╝╚══════╝           ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝ v4
  Coded by Kimzzkece
  github: https://github.com/Kimzz41
\033[33;4mVersion:\033[0m 4            \033[33;4mCTRL+C:\033[0m exit          \033[33;4mAuthor:\033[0m Kimzzkece
...
read -p "Nomor transaksi: " islem
if [[ $islem == 1 || $islem == 01 ]]; then
clear

echo -e "\033[47;31;5m Menginstal pembaruan dan persyaratan...\033[0m"
sleep 5
pkg install git -y
...
apt upgrade -y
clear
echo -e "\033[47;3;35m Pembaruan penuh...\033[0m"
sleep 3
bash alhack.sh

elif [[ $islem == 2 || $islem == 02 ]]; then
clear
echo -e "\033[47;3;35m Instalasi mungkin memakan waktu beberapa saat.\033[0m"
sleep 3
cd Tools
...
cd subscan
read -p "Masukkan domain, misalnya (example.com): " sc
./subscan $sc
...
echo -e "\033[47;3;35m Instalasi ini akan memakan waktu lama.\033[0m"
echo -e "\033[47;3;35m Untuk berhenti, tekan Ctrl+C.\033[0m"
sleep 4
php index.php update-nodes
php index.php refine-nodes
echo "-------------------------"
read -p "Masukkan alamat email yang akan dibombardir.: " mail
echo "-------------------------"
...
python3 DRipper.py
echo ""
echo -e "\033[47;3;35m Sebelum menggunakannya, sembunyikan IP Anda.j\033[0m"
...
clear
echo -e "\033[47;3;35m PROGRAM YANG DIUNDUH SEDANG DIHAPUS...\033[0m"
sleep 3 
rm -rf Tools
...
clear
echo -e "\033[47;3;35m Instalasi mungkin memerlukan waktu beberapa saat\033[0m"
sleep 3
cd Tools
pkg install git
pkg install python2
...
clear
echo -e "\033[47;3;35m Instalasi mungkin memakan waktu beberapa saat.\033[0m"
echo -e "\033[47;3;35m Alat ini akan mengharuskan Anda untuk (ROOT)\033[0m"
sleep 3
cd Tools
...
echo -e "\033[47;3;35m buka browser Anda / ubah proxy (sock proxy) në 127.0.0.1:9050\033[0m"
sleep 8
python3 install.py
aut
	...
	clear
        echo -e '\033[36;40;1m Anda memasukkan kode yang salah.'	
	sleep 1
	clear 
	bash alhack.sh
fi
